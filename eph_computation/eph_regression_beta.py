...
#     network_list = ['barabasi_albert']
    ...
    results_dir = '../beta_regression_result_85stop_10%init_nodes-v3/unweighted/'
    ...
    for network_name in network_list:
        ...
        for filename in os.listdir(directory):
            if filename.endswith('.csv') and not filename.endswith('EPH-v3.csv'):
