...
def main():
    ...
    for network_name in network_list:
        ...
        for beta in simple_betas:
            output_file = f'../result_85stop_10init_nodes-v3/unweighted/unweighted_simple_{network_name}_beta_{beta}.csv'
    ...
    for network_name in network_list:
        ...
        for theta in complex_thetas:
            for prob_complex in complex_probs:
                if prob_complex > 0:
                    output_file = f'../result_85stop_10init_nodes-v3/unweighted/unweighted_complex_{network_name}_theta_{theta}_prob_{prob_complex}.csv'
                    if os.path.exists(output_file):
                        print(output_file, "   already exist continue")
                        continue 
                    complex_params = {
